...
void ChConstraintRigidFluid::GenerateSparsity() {
  ...
  for (int index = 0; index < num_rigid_fluid_contacts; index++) {
    ...
    int rigid = body_id.x;
    int fluid = body_id.y;
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 0, rigid * 6 + 0, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 0, rigid * 6 + 1, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 0, rigid * 6 + 2, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 0, rigid * 6 + 3, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 0, rigid * 6 + 4, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 0, rigid * 6 + 5, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 0, num_rigid_bodies * 6 + num_shafts + fluid * 3 + 0, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 0, num_rigid_bodies * 6 + num_shafts + fluid * 3 + 1, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 0, num_rigid_bodies * 6 + num_shafts + fluid * 3 + 2, 1);
    D_T.finalize(num_unilaterals + num_bilaterals + index * 3 + 0);

    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 1, rigid * 6 + 0, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 1, rigid * 6 + 1, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 1, rigid * 6 + 2, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 1, rigid * 6 + 3, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 1, rigid * 6 + 4, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 1, rigid * 6 + 5, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 1, num_rigid_bodies * 6 + num_shafts + fluid * 3 + 0, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 1, num_rigid_bodies * 6 + num_shafts + fluid * 3 + 1, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 1, num_rigid_bodies * 6 + num_shafts + fluid * 3 + 2, 1);
    D_T.finalize(num_unilaterals + num_bilaterals + index * 3 + 1);

    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 2, rigid * 6 + 0, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 2, rigid * 6 + 1, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 2, rigid * 6 + 2, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 2, rigid * 6 + 3, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 2, rigid * 6 + 4, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 2, rigid * 6 + 5, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 2, num_rigid_bodies * 6 + num_shafts + fluid * 3 + 0, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 2, num_rigid_bodies * 6 + num_shafts + fluid * 3 + 1, 1);
    D_T.append(num_unilaterals + num_bilaterals + index * 3 + 2, num_rigid_bodies * 6 + num_shafts + fluid * 3 + 2, 1);
