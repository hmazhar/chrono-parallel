...
bool chrono::collision::GJKFindPenetration(const ConvexShape& shape0, const ConvexShape& shape1, sResults& results) {
...
bool chrono::collision::GJKCollide(const ConvexShape& shape0, const ConvexShape& shape1, sResults& results) {
  ...
  while (true) {
    ...
    // printf("m_cachedSeparatingAxis: %f, %f, %f  ", m_cachedSeparatingAxis.x, m_cachedSeparatingAxis.y,
    ...
    // std::cout <<TransformSupportVert(shape1, seperatingAxisInB) <<LocalSupportVert(shape1, seperatingAxisInB)
    // <<SupportVert(shape1, seperatingAxisInB);
    ...
    // printf("newCachedSeparatingAxis: %f, %f, %f  \n", newCachedSeparatingAxis.x, newCachedSeparatingAxis.y,
    // newCachedSeparatingAxis.z);
